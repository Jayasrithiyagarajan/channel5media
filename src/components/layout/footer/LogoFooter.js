...
import logoImag3 from "@/assets/img/logo/project_1.png";
      ...
      >
        <div className="footer__logo">
          {style === 2 ? (
            ...
            <Image src={logoImag3} alt="" height={100} width={100}/>
          )}
        </div>
        <div className="footer__text">
          <p>
          We are a neutral and inclusive media outlet that champions diverse viewpoints in governance and public affairs. Dedicated to amplifying the voiceless, our skilled journalists offer thorough, captivating coverage in todays rapid-moving environment
          </p>
        </div>
